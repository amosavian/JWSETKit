...
public struct JSONWebTokenClaimsPublicOIDCStandardParameters {
    ...
    public var givenName: String? { fatalError() }
    
    /// Surname(s) or last name(s) of the End-User.
    ///
    /// Note that in some cultures, people can have multiple family names or no family name;
    /// all can be present, with the names being separated by space characters.
    public var familyName: String? { fatalError() }
    ...
    public var middleName: String? { fatalError() }
    
    /// Casual name of the End-User that may or may not be the same as the ‍`given_name`.
    ///
    /// For instance, a `nickname` value of `Mike` might be returned alongside a `given_name` value of `Michael`.
    public var nickname: String? { fatalError() }
    ...
    public var preferredUsername: String? { fatalError() }
    
    /// URL of the End-User's profile page. The contents of this Web page SHOULD be about the End-User.
    public var profileURL: URL? { fatalError() }
    ...
    public var pictureURL: URL? { fatalError() }
    ...
    public var websiteURL: URL? { fatalError() }
    ...
    /// The RP MUST NOT rely upon this value being unique, as discussed in
    /// [Section 5.7](https://openid.net/specs/openid-connect-core-1_0.html#ClaimStability).
    public var email: String? { fatalError() }
    ...
    public var isEmailVerified: Bool { fatalError() }
    
    /// End-User's gender.
    ///
    /// Values defined by this specification are `female` and `male`.
    /// Other values MAY be used when neither of the defined values are applicable.
    public var gender: String? { fatalError() }
    ...
    public var birthdate: Date? { fatalError() }
    ...
    public var zoneInfo: TimeZone? { fatalError() }
    ...
    public var locale: Locale? { fatalError() }
    ...
    public var phoneNumber: String? { fatalError() }
    ...
    public var isPhoneNumberVerified: Bool { fatalError() }
    ...
    /// until the date/time.
    public var updatedAt: Date? { fatalError() }
